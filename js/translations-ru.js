...
const translations = {
    "ru": {
        ...
        "about_me": "Обо мне",
        "junior_frontend_developer": "Junior фронтенд-разработчик",
        "intro_text": "Привет, меня зовут Денис, я Junior фронтенд-разработчик с пылающим желанием создавать удивительные пользовательские интерфейсы. Моя страсть к веб-разработке вдохновляет меня постоянно изучать новые технологии и методы. Готов взяться за любую задачу и стремлюсь расти профессионально каждый день.",
